      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          {caseStudies.map((study, index) => (
            <Card key={study.title} className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <Button
                  variant="outline"
                  className="w-full group-hover:bg-primary-bright group-hover:text-white group-hover:border-primary-bright transition-colors bg-transparent"
                >
                  View Case Study
