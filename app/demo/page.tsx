            ...
            <CardContent className="p-6 sm:p-8 md:p-10">
              <form className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="firstName" className="text-slate-700 after:ml-0.5 after:text-rose-600 after:content-['*']">
                    First name
                  </Label>
                ...
                {/* Last name */}
                <div className="space-y-1.5">
                  <Label htmlFor="lastName" className="text-slate-700 after:ml-0.5 after:text-rose-600 after:content-['*']">
                    Last name
                  </Label>
                ...
                <div className="col-span-1 md:col-span-2 space-y-1.5">
                  <Label htmlFor="email" className="text-slate-700 after:ml-0.5 after:text-rose-600 after:content-['*']">
                    Work email
                  </Label>
                ...
                {/* Company size */}
                <div className="space-y-1.5">
                  <Label className="text-slate-700 after:ml-0.5 after:text-rose-600 after:content-['*']">
                    Company size
                  </Label>
                  <Select>
