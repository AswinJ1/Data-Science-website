          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {skills.map((skill) => (
                  <span key={skill} className="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 text-blue-800 text-sm rounded-md">
                    {skill}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyDown={(e) => { if (e.key === "Enter") { e.preventDefault(); addMandatory() } }}
                />
                <Button type="button" variant="outline" onClick={addMandatory}>Add</Button>
              </div>
              <div className="flex flex-wrap gap-2 mt-2">
                {mandatoryRequirements.map((req) => (
                  <span key={req} className="inline-flex items-center gap-1 px-2 py-1 bg-red-50 text-red-700 dark:bg-red-900/20 dark:text-red-400 text-sm rounded-md border border-red-200 dark:border-red-800">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyDown={(e) => { if (e.key === "Enter") { e.preventDefault(); addOptional() } }}
                />
                <Button type="button" variant="outline" onClick={addOptional}>Add</Button>
              </div>
              <div className="flex flex-wrap gap-2 mt-2">
                {optionalRequirements.map((req) => (
                  <span key={req} className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300 text-sm rounded-md border border-gray-200 dark:border-gray-700">
                    {req}
